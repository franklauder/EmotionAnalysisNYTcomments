...
nyt_comments1718['prep'] = nyt_comments1718['commentBody'].fillna("").apply(lambda x: preprocess_for_emotions(x))
...
nyt_comments1718['tokens'] = nyt_comments1718['prep'].apply(lambda d: d['tokens'])
...
nyt_comments1718['cleaned'] = nyt_comments1718['prep'].apply(lambda d: d['cleaned_text'])
...
file_out=open("nyt_comments1718","wb")
pickle.dump(nyt_comments1718, file_out)
file_out.close()
...
file_in=open("nyt_comments1718", 'rb')
nyt_comments1718=pickle.load(file_in)
...
nyt_comments1718["emotion"] = nyt_comments1718["cleaned"].apply(emotion_detection_text2emotion)
