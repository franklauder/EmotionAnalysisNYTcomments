...
Now that we have built our functions we will build a function encorporating all functions in the pre-processing of the text. 

The first part of the function deals with the missing values by replacing them with an empty string. 
...
After transformation to a string, white space is removed. 
